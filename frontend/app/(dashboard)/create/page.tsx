...
<div className="mb-6">
  ...
  <button
    ...
    className="w-full group bg-surface border border-border hover:border-heading rounded-xl px-6 py-5 shadow-sm transition-colors flex items-center gap-4 text-left"
  >
